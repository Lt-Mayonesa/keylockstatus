...
const Meta = imports.ui.appletManager.appletMeta["keylockstatus@lt-mayonesa"];
...
MyApplet.prototype = {
    ...
    _init: function (orientation) {
        ...
        this.set_applet_tooltip(_("Lock Indicator"));
    ...
    _updateState: function () {
        ...
        this.set_applet_tooltip('Caps: ' + (this.capslock_state ? 'On' : 'Off') + ' | Num: ' + (this.numlock_state ? 'On' : 'Off'));
    },
